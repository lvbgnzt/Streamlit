    ...
    def _format_context(self, documents: List[QueryResult]) -> str:
        ...
        for i, doc in enumerate(documents):
            ...
            if self.config.include_sources:
                ...
                source_url = doc.metadata.get("source_url") or doc.metadata.get("url", "Unknown source")
...
if __name__ == "__main__":
    ...
    if not api_key:
        ...
        print("You need to create a .env file in the project root with your OpenAI API key:")
